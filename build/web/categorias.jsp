		...
		<header class="container mt-5">
			<div class="row">
				...
				<div class="col-2 mt-2">
					<a href="categoria.jsp" class="btn btn-outline-primary w-100">Nova categoria</a>
				</div>
			</div>
		</header>
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="input-group mb-3">
						...
						<div class="input-group-append">
							<button class="btn btn-secondary" type="button" id="pesquisaCategoria">Pesquisar</button>
						</div>
					</div>
				</div>
			</div>
